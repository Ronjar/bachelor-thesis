...
\maketitle
\begin{center}
    Studiengang: Informatik - M. Ed. (Erw) \\
    Prüfer/in: Jun.-Prof. Dr. rer. nat. Maria Wirzberger \\
    Betreuer/in: Jun.-Prof. Dr. rer. nat. Maria Wirzberger, Nadine Nicole Koch, M.Sc. \\
    Beginn am: 5. Juni 2023 \\
    Beendet am: 5. Dezember 2023
\end{center}


%%\input{content/introduction}
\input{content/theoretical_background}
